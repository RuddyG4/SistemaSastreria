                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($dato->cantidad >= 150)
                                    <span class="label stock-label">Stock Alto</span>
                                    @elseif($dato->cantidad < 150 && $dato->cantidad >= 50)
                                        <span class="label label-info">Stock Medio</span>
                                        @elseif($dato->cantidad < 50 && $dato->cantidad > 0)
                                            <span class="label label-warning">Stock Bajo</span>
                                            @elseif($dato->cantidad < 1) <span class="label label-danger">Stock Agotado</span>
                                                @endif
                                </td>
                            </tr>
                            @endforeach
