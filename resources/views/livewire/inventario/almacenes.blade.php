            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th>Nombre</th>
                        <th>ubicacion</th>
                        @if(in_array('almacen.modificar', $permisos) || in_array('almacen.eliminar', $permisos))
                        <th>Opciones</th>
                        @endif
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if(in_array('almacen.modificar', $permisos))
                            ...
                            @endif
                            @if(in_array('almacen.eliminar', $permisos))
                            <button data-bs-toggle="modal" data-bs-target="#modalDeDelete" class="btn btn-danger" wire:click="delete( {{ $almacen->id }} )">Eliminar</button>
                            @endif
                        </td>
                    </tr>
                    @endforeach
