...
<div>
            ...
            <form form wire:submit.prevent="store" id="form-id">
                ...
                <div class="input-group mb-3">
                    <input wire:model.lazy="nombre" placeholder="Agregar vestimenta"  type="text" class="form-control" aria-label="Text input with dropdown button">
                    
                    <select class="form-select d-inline me-2 p-10" id="genero" wire:model="genero">
