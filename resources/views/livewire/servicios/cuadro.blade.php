<x-slot:title>
    ...
    <div>
        ...
        <div id="draggableElement" class="draggable">Arrástrame</div> --}}
            ...
            {{-- <button id="guardarBtn" class="btn btn-primary"  wire:click="" >Guardar</button> --}}

            <button id="guardarBtn" class="btn btn-danger" wire:click="$emit('guardar')"><i class="fa fa-trash"></i> guardar</button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#guardarBtn").click(function() { 
            ...
            // Aquí puedes realizar una petición AJAX o emitir un evento de Livewire para enviar las posiciones al backend y actualizar la base de datos
            // Livewire.emit('guardarPosiciones', currentPosition);

            Livewire.on('guardar', currentPosition => {
            
                
                    Livewire.emitTo('servicios.cuadro', 'guardarPosiciones', currentPosition);
            })
            // Livewire.emitTo('servicios.cuadro', 'guardarPosiciones', currentPosition);
        });
    ...
    //    $("#guardarBtn").click(function() { 
    //        Livewire.on('guardarPosiciones', currentPosition => {
